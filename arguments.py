...
def get_argument_parser():
    ...
    parser.add_argument('--logger_name', default='runs_add/coco-5-28',
                        help='Path to save Tensorboard log.')
    parser.add_argument('--model_name', default='runs_add/coco-5-28',
    ...
    parser.add_argument("--lr_schedules", default=[9,15,19,21], type=int, nargs="+",   #15,25  [9,15,18,20]   9,15,20,25
    ...
    parser.add_argument('--coco_img_path', type=str, default='D:/datasets/coco/images', help='the path of coco images')
    ...
    parser.add_argument('--hubness_weight', type=float, default=0.8,
